...
public class WsRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = WsRefreshLayout.class.getSimpleName();
    ...
    public int CIRCLE_BG_LIGHT = 0xFFFAFAFA;
     ...
     * @param context
     */
    public WsRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public WsRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
