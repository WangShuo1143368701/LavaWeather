...
public class Today24HourView extends View{
    ...
    private static final int WINDY[] = {2, 2, 3, 3, 3,
            ...
            2, 2, 2, 3, 3,
            3, 5, 5, 5};
    private static final int WEATHER_RES[] ={R.drawable.w0, R.drawable.w1, R.drawable.w3, -1, -1
    ...
    private void init() {
        ...
        mHeight = 500; //暂时先写死
        tempBaseTop = (500 - bottomTextHeight)/4;//110
        tempBaseBottom = (500 - bottomTextHeight)*2/3;//294
    ...
    private void initHourItems(){
        ...
        for(int i=0; i<ITEM_SIZE; i++){
            ...
            //风力的box; top值= 总高-下边的“时间文字高”-“最大风力”的高 + 当前份数/总份数*总份数的高
            ...
            hourItem.windyBoxRect = rect;///风力的box
            hourItem.time = time;
            hourItem.windy = WINDY[i];
            hourItem.temperature = TEMP[i];
            hourItem.tempPoint = point; //温度折线的点
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //初始滑动位置
       /* if(getParent() instanceof IndexHorizontalScrollView){
            ((IndexHorizontalScrollView) getParent()).scrollTo(MARGIN_LEFT_ITEM+ITEM_WIDTH*10,0);
        }*/
    }
