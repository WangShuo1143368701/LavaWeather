 ...
 * 太阳和风速
 *
 * Created by Shuo.Wang on 2016/12/22.
 *
 */
public class AstroView extends View {
    ...
    private Weather.DailyForecastBean todayForecast;
    private Weather.NowBean now;
    ...
    public void setData(Weather weather) {
                ...
                this.now = weather.getNow();
                final Weather.DailyForecastBean forecast = WeatherUtil.getTodayDailyForecast(weather);
                if (forecast != null) {
...
//		setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        Typeface tf = Typeface.createFromAsset(context.getAssets(), WeatherUtil.xmTf);
